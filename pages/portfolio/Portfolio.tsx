...
const Portfolio: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      {/* Blog Section */}
      <section id="blog" className="px-8 lg:px-16 py-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl lg:text-6xl font-bold mb-4 text-center bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
            ML Blog
          </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <Link href="/portfolio/blog#ml-models" className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:border-purple-400/40">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">Explore supervised, unsupervised, and deep learning models — from linear regression to LLMs. Click any card for strengths, limitations, and real-world use cases.</p>
            </Link>
            <Link href="/portfolio/blog#neural-networks" className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:border-pink-400/40">
            ...
            <Link href="/portfolio/blog#explainable-ai" className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:border-emerald-400/40">
