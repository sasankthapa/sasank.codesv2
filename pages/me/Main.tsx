...
const Main:React.FC<StaticProps>=({recent,frontend,ml,algo})=>{
    ...
    return <div className="p-2 overflow-hidden font-inter sm:px-16 md:pt-4 md:px-32 lg:px-52 xl:px-60 2xl:px-80 2xl:pt-10">
      <Header/>
      <SlideFromRight> 
      <div className="w-full mt-3 text-left md:mt-6 xl:mt-10">
          <h1 className="inline font-bold xl:leading-8">{'About me: '}</h1>
          <p className="inline">I am a passionate computer science enthusiast, problem solver and coder.
          I revel in learning new technologies and implementing algorithms. I <i>have</i> looked in awe at some well-written and concise lines of code.</p>
          <p></p>
          </div>
      </SlideFromRight>
